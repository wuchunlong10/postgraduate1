...
<body>
	<form action="ZWTshowListForTeacher.html" method="post">
		<select name="select">
	...
	<table>
		...
		<c:forEach items="${fileList}" var="file">
			<tr>
				...
				<td>
				<c:if test="${file.fileOwnerName==0}">
				
				<form action="ZWTdeletefileByID.html">
						<input id="fileid" type="hidden" name="fileid"
							value="${file.fileid}" /> <input type="submit" value="删除" />
					</form>
